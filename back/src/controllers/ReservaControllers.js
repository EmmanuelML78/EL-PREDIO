...
const payReserver = async (req, res) => {
  ...
  let preference = {
    ...
    back_urls: {
      success: "https://el-predio-production.up.railway.app//success", // redirect to this url if payment is successful
      failure: "https://el-predio-production.up.railway.app//failure", // redirect to this url if payment fails
      pending: "https://el-predio-production.up.railway.app//pending", // redirect to this url if payment is pending
    },
